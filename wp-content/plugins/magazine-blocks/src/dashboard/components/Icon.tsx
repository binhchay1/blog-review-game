/* eslint-disable */
import { chakra, forwardRef, IconProps } from "@chakra-ui/react";
...
export const Modal = forwardRef<IconProps, "svg">((props, ref) => (
	<chakra.svg
		viewBox="0 0 24 24"
		xmlns="http://www.w3.org/2000/svg"
		{...props}
		ref={ref}
	>
		<path d="M7.62 13.89c0-.46.38-.84.84-.84h7.92c.46 0 .84.38.84.84s-.38.84-.84.84H8.46c-.47 0-.84-.37-.84-.84zm0 3.36c0-.46.38-.84.84-.84h7.92c.46 0 .84.38.84.84s-.38.84-.84.84H8.46c-.47 0-.84-.37-.84-.84zm10.68-7.11c.28-.28.28-.74 0-1.02l-.95-.95.95-.95c.29-.28.3-.73.02-1.02a.715.715 0 0 0-1.02-.02l-.02.02-.95.95-.95-.95a.724.724 0 0 0-1.02 0c-.28.28-.28.74 0 1.02l.95.95-.95.95c-.28.28-.28.74 0 1.02s.74.28 1.02 0l.95-.95.95.95c.29.29.74.29 1.02 0z" />
		<path
			d="M2.34 4.89a2.88 2.88 0 0 1 2.88-2.88h14.4a2.88 2.88 0 0 1 2.88 2.88v14.4a2.88 2.88 0 0 1-2.88 2.88H5.22a2.88 2.88 0 0 1-2.88-2.88V4.89zm2.88-.87h14.4c.49 0 .88.39.88.88v14.4c0 .48-.39.88-.88.88H5.22c-.48 0-.88-.39-.88-.88V4.89c0-.48.39-.87.88-.87z"
			fillRule="evenodd"
			clipRule="evenodd"
		/>
	</chakra.svg>
...
export const latestPosts = forwardRef<IconProps, "svg">((props, ref) => (
	<chakra.svg
		viewBox="0 0 24 24"
		xmlns="http://www.w3.org/2000/svg"
		{...props}
...
GridModule.displayName = "GridModule";
Heading.displayName = "Heading";
Advertisement.displayName = "Advertisement";
BannerPosts.displayName = "BannerPosts";
FeaturedCategories.displayName = "FeaturedCategories";
TabPost.displayName = "TabPost";
